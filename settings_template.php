...
define('BOT_WEBHOOK', 'https://TTTTTTTTT/start.php'); // url assoluto https per start.php
...
define('GDRIVEGID2', '0'); // gid dell'eventuale altro foglio di calcolo per esempio foglio Risposte
define('GDRIVEGID3', ''); // gid dell'eventuale altro foglio di calcolo per esempio sedi azienda/sindacato
define('NAME', 'Napoli Fly'); // nome del Bot che appare nelle Informazioni /start
